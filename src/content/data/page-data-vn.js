...
export const pageDataVN = {
  navbar: {
    links: [
      ...
      { name: "Liên hệ", href: "/vn#footer" },
      {
        name: (
          <>
            PL/<strong style={{ color: "#151070" }}>VN</strong>
          </>
        ),
        href: "/",
      },
  ...
  title: {
    paragraph: "bổ sung chế độ ăn uống cho nam giới đang cố gắng có con",
    heading: "Hỗ trợ sinh sản tối ưu",
  },
  aboutTenferil: {
    heading:
      "Sản phẩm được bào chế theo công nghệ hiện đại với nguồn nguyên liệu an toàn, chất lượng. TENfirtil On được đánh giá rất cao trong việc tối ưu hoá được mọi tính năng của sinh sản, hỗ trợ sinh lý nam tối ưu nhất.",
    paragraph:
      "Gồm có 10 thành phần chính: Carnitine, Choline, kẽm, Vitamin C, Coenzyme Q10, Axit Amin, Vitamin E, Selen, Vitamin B12, Axit Folic.",
    buttonLabel: "tải nội dung hướng dẫn sử dụng thuốc",
  },
  leftBorderP: [
  ...
  breakerFacts: {
    heading: "Bạn là đàn ông và bạn đang có kế hoạch sinh con khỏe mạnh?",
    texts: ["Bạn có biết rằng?"],
    id: "facts",
  },
  facts: [
    {
      header: "gần 1/3 bệnh nhân",
      text:
    ...
    },
    {
      ...
      text:
        "Sử dụng Selen hữu cơ sẽ giúp cơ thể con người hấp thụ nhanh và tốt hơn so với selen thường. Trong sản phẩm này được cho 1 liều selen thấp - 40 mcg vì selen hữu cơ dễ tích tụ trong cơ thể hơn. Việc thừa Selen cũng dần đến các tác hại cho cơ thể, thường xuyên xảy ra các dấu hiệu xấu như (tiêu chảy, buồn nôn, hơi thở có mùi, mệt mỏi, rụng tóc, bị hói, đổi màu móng tay, đau khớp, thúc đẩy bệnh tiểu đường giai đoạn III).",
    },
  ],
  breakerTips: {
    heading: "Bạn là đàn ông và bạn đang có kế hoạch sinh con khỏe mạnh?",
    texts: [
      "Không có gì dễ dàng hơn - hãy chăm sóc bản thân thật tốt! Để mục tiêu của bạn đạt được sớm nhất, dưới đây là một số lời khuyên của chúng tôi mà bạn nên nhớ",
    ],
    id: "facts",
  },
  tips: [
